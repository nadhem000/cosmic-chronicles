# Cosmic Chronicles - Astronomy News PWA

Cosmic Chronicles is a Progressive Web Application (PWA) that delivers the latest astronomy news, missions, gallery images, and educational content in a multi-language, multi-page format.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/nadhem000/cosmic-chronicles.git
...
### PWA Settings
- App name: Cosmic Chronicles
- Short name: CosmicNews
...
2. Or use Chrome menu → "Install Cosmic Chronicles"
...
1. Check [Issues](https://github.com/nadhem000/cosmic-chronicles/issues)
2. Email: developer@cosmic-chronicles.com
3. Twitter: @CosmicChronicles
