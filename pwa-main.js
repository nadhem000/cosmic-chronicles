...
class PWAInstaller {
    ...
    showInstallPromotion() {
        ...
        if (!installBtn) {
            ...
            installBtn.title = 'Install Cosmic Chronicles as an app';
            installBtn.setAttribute('aria-label', 'Install Cosmic Chronicles app');
            ...
            updateNotification.innerHTML = `
                <div class="AN-pwa-update-content">
                    ...
                    <div class="AN-pwa-update-text">
                        ...
                        <span>A new version of Cosmic Chronicles is available.</span>
                    </div>
    ...
    showWelcomeNotification() {
        if (this.notificationPermission === 'granted' && this.registration) {
            this.registration.showNotification('Cosmic Chronicles', {
                body: 'Welcome to Cosmic Chronicles! You\'ll now receive updates about space discoveries.',
